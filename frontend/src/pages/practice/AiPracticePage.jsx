...
export default function AiPracticePage() {
  ...
  const [aiMessage, setAiMessage] = useState("?àÍ? ?úÏùº Ï¢ãÏïÑ?òÎäî ?åÏãù?Ä Î≠êÏïº?");
  ...
  // AI Î∞úÌôî ?ÅÌÉú???òÏ§ë???§Ï†ú AI ?∞Í≤∞ ???¨Ïö©
  // setIsAiSpeaking(true/false), setAiVoiceLevel(0~1) Î°??úÏñ¥
          ...
          <div className={styles.Stage}>
            ...
            <aside className={styles.RightStage} aria-label="AI ?ÑÏö∞ÎØ?>
              <div className={styles.AiSpeechBubble}>
                <div className={styles.AiSpeechDot}>??AI ?òÎçï ??/div>
